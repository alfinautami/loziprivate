...
<body>
    ...
    <section id="aboutUs">
        <div class="px-4 py-3">
            ...
            <H2 >DISKON 40 % </H2>
            <h3>HARGA CUMA 200K</h3>
            <div class="col-lg-6 mx-auto">
                <p class="mb-2" data-aos="zoom-in" data-aos-duration="900">
                    Bimbingan private class endorsement khususnya di instagram. Memberikan bimbingan kepada peserta agar dapat memperoleh penghasilan bermodalkan sosial media khususnya instagram. Dengan memperoleh jobs paid promote dan endorse. Ratusan testimoni melimpah di Instagram 
                </p>
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a class="btn btn-secondary" data-aos="flip-up" data-aos-duration="1200" href="https://www.instagram.com/lozi.management/">Selengkapnya</a>
                    <!-- https://wa.me/6281225667642?text=Saya%20ingin%20bertanya%20mengenai%20private%20class%20Lozi%20Management20% -->
                </div>
            </div>
        </div>
    </section>
