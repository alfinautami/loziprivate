                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="tambah-testi.php" class="btn btn-primary"><i class="fas fa-paperclip mr-2"></i> Tambah Data Testimoni</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <!-- <td><?php echo $tdata['id_testi']; ?></td> -->
                                                <td><?php echo $tdata['username_testi']; ?></td>
                                                <td><?php echo $tdata['komentar']; ?></td>

                                                <td class="d-flex flex-row align-items-center text-center justify-content-center" style="height: 100px;">
                                                <a href="ubah-testi.php?id_testi=<?php echo $tdata['id_testi'];  ?>" type="button" class="btn btn-warning m-2">Ubah</a>

                                                <a href='./hapus-testi.php?id_testii=<?php echo $tdata['id_testi']; ?>' onclick="return confirm('Yakin Akan Dihapus?')" class="btn btn-danger">Hapus</a>
