...
<head>
    ...
    <title>Login Private Class</title>
        ...
        <div class="col-md-12">
          <div class="p-5">
            <div class="text-center">
              <img src="img/lozilogo.png" alt="Logo sekolah" class="logo-login">
              <h1 class="h4 text-gray-900">Private Class</h1>
            ...
            <hr>
            <div class="text-center">
              <a class="small" href="registerpeserta.php">Registrasi Peserta Baru!</a>
            </div>
          </div>
        </div>
      </div>
